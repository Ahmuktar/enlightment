        ...
        <section className="lg:flex sm:container items-center justify-center">
            <div className="w-full mt-[6%] lg:ml-[15%] items-center justify-center">
                <div className="lg:w-[60%]">
                    ...
                    <p className="font-normal text-2xl my-10 text-black">
            ...
            <div className="mx-auto flex flex-col text-center items-center justify-center w-fit">
                ...
                <div className="container text-left flex sm:flex-col items-start gap-10">
                    <div className="w-full py-10 lg:py-20 px-10 lg:px-14 border-b-8 border-secondary bg-gray-1">
                        ...
                        <p href="/" className="text-xl font-bold">348S, 11th St. Philly, NY 24107</p>
                    </div>
                    <div className="w-full py-10 lg:py-20 px-10 lg:px-14 border-b-8 border-primary bg-gray-1">
                        <h1 className="text-4xl font-bold mb-6">Over the phone or email</h1>
                        <p className="text-2xl mb-11 text-gray">Call us on our hotline and the specialists will tell you how it is better to make a payment. They will also discuss your intentions.</p>
                        <p href="/" className="text-xl font-bold">+1 234 567 8901
                            or
        ...
        <section className="h-fit lg:h-[812px] lg:pb-[151px] w-full bg-[url('/images/bg.webp')] bg-no-repeat bg-center bg-cover text-slate-50">
            <div className="container flex items-center">
                <div className="lg:max-w-[65%] py-[70px] lg:py-[150px]">
                    ...
                    <p className="text-2xl my-4">Basic information needed to make a decision can be learned very quickly on the site or during a conversation.</p>
                    <div className="mt-16 lg:my-16">
                        <Link href="/contacts" type="button" className="bg-secondary text-lg font-semibold text-[#222] rounded-full hover:bg-primary w-full py-5 px-20">
                            Volunteer Now
                        </Link>
                    </div>
                </div>
