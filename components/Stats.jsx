        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-24">
          ...
          <div className="flex justify-center flex-col items-center">
            <h1 className="text-5xl lg:text-[72px] font-bold text-primary">
              {isInView && <CountUp end={150} duration={2} />}
            </h1>
            <p className="text-xl lg:text-2xl font-semibold text-primary">Successful Projects</p>
          </div>

          {/* Funds Raised */}
          <div className="flex justify-center flex-col items-center">
            <h1 className="text-5xl lg:text-[72px] font-bold text-primary">
              {isInView && <CountUp end={35} suffix="M" duration={2} />}
            </h1>
            <p className="text-xl lg:text-2xl font-semibold text-primary">Funds Raised</p>
          </div>

          {/* Lives Impacted */}
          <div className="flex justify-center flex-col items-center">
            <h1 className="text-5xl lg:text-[72px] font-bold text-primary">
              {isInView && <CountUp end={500} suffix="k" duration={2} />}
            </h1>
            <p className="text-xl lg:text-2xl font-semibold text-primary">Lives Impacted</p>
          </div>
        </div>
      </div>
    </section>
