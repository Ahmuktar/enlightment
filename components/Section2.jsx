    ...
    <section className="container lg:flex items-center pt-[50px] pb-10 lg:pb-[150px] justify-center">
        ...
        <div className="w-full">
            <div className="lg:pl-[146px] sm:mt-5 pr-[15px] flex flex-col justify-center">
                ...
                <p className="font-normal text-xl lg:text-2xl mb-3 lg:my-10 text-gray">
                ...
                <div className="">
                    <div className="flex items-center mb-2 lg:mb-5 gap-6">
                        ...
                        <p className="font-normal text-xl lg:text-2xl text-black">Medicine help</p>
                    </div>
                    <div className="flex items-center mb-2 lg:mb-5 gap-6">
                        <Check className="text-primary" />
                        <p className="font-normal text-xl lg:text-2xl text-black">We build and create</p>
                    </div>
                    <div className="flex items-center mb-2 lg:mb-5 gap-6">
                        <Check className="text-primary" />
                        <p className="font-normal text-xl lg:text-2xl text-black">Water delivery</p>
                    </div>
                    <div className="flex items-center mb-2 lg:mb-5 gap-6">
                        <Check className="text-primary" />
                        <p className="font-normal text-xl lg:text-2xl text-black">We care about</p>
                    </div>
                    <div className="flex items-center mb-2 lg:mb-5 gap-6">
                        <Check className="text-primary" />
                        <p className="font-normal text-xl lg:text-2xl text-black">Education help</p>
                    </div>
                </div>
            </div>
        </div>
