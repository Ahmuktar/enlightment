  ...
  <div className="w-full">
    <div className="lg:pl-[146px] sm:mt-5 pr-[15px] flex flex-col justify-center">
      ...
      <p className="font-normal text-lg lg:text-xl mb-3 lg:my-10 text-gray-700">
        Binarify Community Outreach is committed to making a meaningful difference in the lives of underserved communities through comprehensive programs that address vital needs.
      </p>
